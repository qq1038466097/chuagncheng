<template>
	<view class="content dotBg">
        ...
        <view class='dot-contBox'>
			<view v-for="(item,i) in rules" :key='i'>
				...
				<view v-if="rolesCode=='dotRole'&&item.selected==2" :class="i>hasNum?'grayBgView':''">
					...
					<view class='report-showcont reportLine flex'>
						...
						<switch @change="switchChange" :id="item2.itemId" color="#0091FF" style="transform:scale(0.8);" />
					</view>
				</view>
            </view>
            ...
            <view class='subBtn' v-if="hasNum===totalNum" @click="subDot">
...
<!--
<view :class="i>hasNum?'report-showcont grayBgView':'report-showcont'" @click="showtipWhy(i,hasNum)"> 
-->
