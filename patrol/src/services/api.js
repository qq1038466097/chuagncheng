...
/* 点位add */
export async function dotAdd (params) {
...
/* 点位详情 */
export async function dotDetail (params) {
...
export async function myCheckPointCount (params) {
    let _url = cardUrl+'checkpoint/myCheckPointCount'
    //let _headers = {}
    return request(_url,{
	    method: 'POST',
        body: params,
...
export async function messupdateCfg (params) {
    let _url = cardUrl+'watchEvent/updateCfg'
    return request(_url,{
	    method: 'POST',
	    body: params
    })
...
//消息通知-delete
export async function noticeDelte (params) {
    let _url = cardUrl+'notice/delte'
    return request(_url,{
	    method: 'POST',
	    body: params
    })
...
//消息通知-save
export async function noticeSave (params) {
    let _url = cardUrl+'notice/save'
    return request(_url,{
	    method: 'POST',
	    body: params
    })
